  ...
  function getChatbotResponse(userMessage) {
    ...
    if (currentLanguage === 'en') {
      if (userMessage.toLowerCase().includes('hello')) {
        ...
        botResponse = "I see you're interested in exploring Tamil Nadu's heritage in detail. Let me provide more personalized recommendations.";
      } else {
        botResponse = "I'm here to help you discover heritage sites. Please ask about a specific site or feature!";
      }
    } else {
